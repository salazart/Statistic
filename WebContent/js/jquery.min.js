...
(function (e, t) {
    ...
    v.fn.extend({
        ...
        remove: function (e, t) {
            var n, r = 0;
            for (;
            (n = this[r]) != null; r++) if (!e || v.filter(e, [n]).length)!t && n.nodeType === 1 && (v.cleanData(n.getElementsByTagName("*")), v.cleanData([n])),
    ...
    v.extend({
        ...
        clean: function (e, t, n, r) {
            ...
            if (n) {
                ...
                for (s = 0;
                (u = b[s]) != null; s++) if (!v.nodeName(u, "script") || !m(u)) n.appendChild(u),
